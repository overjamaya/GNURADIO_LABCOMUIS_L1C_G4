...
class lab_p2_2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "lab_p2_2", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lab_p2_2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab_p2_2")
...
def main(top_block_cls=lab_p2_2, options=None):
